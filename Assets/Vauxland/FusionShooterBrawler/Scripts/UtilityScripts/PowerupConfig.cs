...
{
    [CreateAssetMenu(fileName = "PowerUpConfig", menuName = "FusionBrawler/PowerUpConfig")]
    public class PowerupConfig : ScriptableObject
    {
        [Header("Power-Up Stats")]
        public StatDictionary powerUpStats; // define the stats this powerup will affect
    }
}